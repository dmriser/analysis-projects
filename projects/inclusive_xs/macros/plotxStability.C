{
  ...
  readIntegratedHisto(stability200, inputFile, numberSector, "stability200Bins_xByQQ");
  readIntegratedHisto(stability100, inputFile, numberSector, "stability100Bins_xByQQ");
  readIntegratedHisto(stability66, inputFile, numberSector, "stability66Bins_xByQQ");
  readIntegratedHisto(stability50, inputFile, numberSector, "stability50Bins_xByQQ");
  readIntegratedHisto(stability40, inputFile, numberSector, "stability40Bins_xByQQ");
  readIntegratedHisto(stability34, inputFile, numberSector, "stability34Bins_xByQQ");
  readIntegratedHisto(stability20, inputFile, numberSector, "stability20Bins_xByQQ");
  readIntegratedHisto(stability10, inputFile, numberSector, "stability10Bins_xByQQ");
