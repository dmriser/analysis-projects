{
  ...
  readIntegratedHisto(purity200, inputFile, numberSector, "purity200Bins_wByQQ");
  readIntegratedHisto(purity100, inputFile, numberSector, "purity100Bins_wByQQ");
  readIntegratedHisto(purity66, inputFile, numberSector, "purity66Bins_wByQQ");
  readIntegratedHisto(purity50, inputFile, numberSector, "purity50Bins_wByQQ");
  readIntegratedHisto(purity40, inputFile, numberSector, "purity40Bins_wByQQ");
  readIntegratedHisto(purity34, inputFile, numberSector, "purity34Bins_wByQQ");
  readIntegratedHisto(purity20, inputFile, numberSector, "purity20Bins_wByQQ");
  readIntegratedHisto(purity10, inputFile, numberSector, "purity10Bins_wByQQ");
